...
def login(driver, email=None, password=None, cookie = None, timeout=10):
    ...
    element = WebDriverWait(driver, 25).until(EC.presence_of_element_located((By.ID, "username")))
    ...
    element = WebDriverWait(driver, 25).until(EC.presence_of_element_located((By.CLASS_NAME, c.VERIFY_LOGIN_ID)))
